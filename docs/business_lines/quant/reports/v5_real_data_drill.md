...
loopharness --db .runtime/v5_quant_drill.db demo seed-console \
  --backup-dir .runtime/v5_backups

LOOPHARNESS_API_TOKENS=dev-token \
  loopharness --db .runtime/v5_quant_drill.db api serve \
...
```bash
cd /Users/lemonsea/Desktop/mas/loop-harness/web
