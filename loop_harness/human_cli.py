"""Human-facing CLI commands for evidence review and workflow control."""
...
from loop_harness.console import ApprovalInbox, BackupManager, ConsoleReadModel, CostEventStore
...
def register_human_parsers(subparsers: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    """Register human-facing evidence and control command groups."""
...
def handle_human_command(args: argparse.Namespace, db_path: str | Path) -> int:
    """Handle human-facing evidence and control command groups."""
