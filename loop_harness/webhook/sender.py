...
from loop_harness.events import Event, EventBus, EventType
...
class WebhookSender:
    """Send selected loop_harness events to external webhook URLs."""
